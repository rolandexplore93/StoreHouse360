namespace StoreHouse360.Domain.Exceptions
{
    public class ZeroLevelExceededException : BaseException
    {
        ...
        public ZeroLevelExceededException(IList<int> productsWithZeroLevelExceeded, string? message = "Zero level exceeded") : base(message, StatusCodes.ZeroLevelExceededExceptionCode)
        {
